                ...
                <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                    <form action="{{ route('kriteria.store') }}" method="POST" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_kriteria" id="nama_kriteria" class="form-input rounded-md shadow-sm mt-1 block w-full" required />
                        </div>
                        ...
                        <div>
                            ...
                            <select name="type" id="type" class="text-gray-700 text-sm rounded-lg block w-full p-2.5" required>
                        ...
                        <div class="flex justify-end">
                            <button type="submit" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-green-500 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                Tambah Kriteria
                            </button>
                        </div>
                    </form>
