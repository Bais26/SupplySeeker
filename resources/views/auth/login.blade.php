        ...
        <div class="min-h-screen flex fle-col items-center justify-center lg:p-6 p-4">
            <div class="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
                <div class="max-md:text-center">
                    ...
                    Selamat Datang, Silahkan Login untuk mulai pencarian
                    </h2>
                    ...
                    <p class="text-sm mt-10 text-white">
                        Tidak Punya Akun?
                        <a href="{{ route('register') }}" class="text-white font-semibold underline ml-1">Daftar Sekarang</a>
                    </p>
                </div>
                <form method="POST" action="{{ route('login') }}" class="bg-white rounded-xl px-6 py-8 space-y-6 max-w-md md:ml-auto max-md:mx-auto w-full">
                    @csrf
