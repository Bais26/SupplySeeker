<!-- resources/views/page/alternative.blade.php -->
                        ...
                        <table class="w-full table-auto">
                            <thead>
                                <tr>
                                    ...
                                    <th class="px-4 py-2">Kode Supplier</th>
                                    <th class="px-4 py-2">Nama Supplier</th>
                                    <th class="px-4 py-2">Bobot Supplier</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="border px-4 py-2">{{ $alternative->kode_supplier }}</td>
                                    <td class="border px-4 py-2">{{ $alternative->nama_supplier }}</td>
                                    <td class="border px-4 py-2">{{ $alternative->bobot_supplier }}</td>
