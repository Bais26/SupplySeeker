...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-gray-100 font-family-karla h-screen bg-fixed bg-no-repeat bg-cover w-screen" style="background-image: url(./image/wp.jpg)">
	  ...
	  <div class="bg-white h-screen rounded-l-3xl">
  		<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  			<div class="sm:mx-auto sm:w-full sm:max-w-sm">
  			  <img class="mx-auto h-10 w-auto" src="{{asset("./image/logo.png")}}" alt="Your Company">
